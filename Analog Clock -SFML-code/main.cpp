...
//************************                         2018 ©                               ************************
//************************                      Analog Clock                           ************************
//************************   FAST NATIONAL UNIVRSITEY OF COMPUTER & EMERGING SCIENCES  ************************
...
int main()
{
    ...
    sf::Font font;
    font.loadFromFile("files/font/arial.ttf");
    ...
    //Buttons
    sf::Texture play1;
    if (!play1.loadFromFile("files/buttons/play.png")){return EXIT_FAILURE;}
    sf::Sprite play;
    ...
    sf::Texture settime1;
    if (!settime1.loadFromFile("files/buttons/settime.png")){return EXIT_FAILURE;}
    sf::Sprite settime;
    ...
    sf::Texture default1;
    if (!default1.loadFromFile("files/buttons/default.png")){return EXIT_FAILURE;}
    sf::Sprite default2;
    ...
    sf::Texture nv;
    if (!nv.loadFromFile("files/buttons/needlevalue.png")){return EXIT_FAILURE;}
    sf::Sprite n;
    n.setTexture(nv);
    n.setOrigin(-200,50);
    ...
    sf::Texture credit1;
    if (!credit1.loadFromFile("files/buttons/credit.png")){return EXIT_FAILURE;}
    sf::Sprite credit;
    ...
    sf::Texture exit1;
    if (!exit1.loadFromFile("files/buttons/exit.png")){return EXIT_FAILURE;}
    sf::Sprite exit2;
    ...
    sf::Texture sfml;
    if (!sfml.loadFromFile("files/sfmllogo.png")){return EXIT_FAILURE;}
    sf::Sprite sfmll;
    sfmll.setTexture(sfml);
    sfmll.setOrigin(510,-310);
    ...
    if (!background.loadFromFile("files/bg.jpg")){return EXIT_FAILURE;}
    sf::Sprite background1;
    background1.setTexture(background);

    sf::Texture texture;
    texture.loadFromFile("files/cursor.png");
...
int AnalogClock()
{
    ...
    if (!clockBrand.loadFromFile("files/bg.jpg")){return EXIT_FAILURE;}
    sf::Sprite clockBrandSprite;
    clockBrandSprite.setTexture(clockBrand);

    //inside Image Clock
    sf::Texture clockinsideImage;
    if (!clockinsideImage.loadFromFile("files/clock.gif")){return EXIT_FAILURE;}
    ...
    //Button Load
    sf::Texture back1;
    if (!back1.loadFromFile("files/buttons/images.jpg")){return EXIT_FAILURE;}
    sf::Sprite back;
    ...
    //Tic Tic Music
    sf::Music clockTick;
      if (!clockTick.openFromFile("files/sound/tic.wav"))
        return EXIT_FAILURE;
...
int set_time()
{
    ...
    sf::Texture hour1;
    if (!hour1.loadFromFile("files/input/enterhours.png")){return EXIT_FAILURE;}
    sf::Sprite hours;
    ...
    sf::Texture minute1;
    if (!minute1.loadFromFile("files/input/enterminutes.png")){return EXIT_FAILURE;}
    sf::Sprite minutes;
    ...
    //buttom=n
    sf::Texture ba;
    if (!ba.loadFromFile("files/buttons/images.jpg")){return EXIT_FAILURE;}
    sf::Sprite bac;
    bac.setTexture(ba);
...
int credits()
{
    ...
    sf::Texture credits;
    if (!credits.loadFromFile("files/credits.png")){return EXIT_FAILURE;}
    sf::Sprite credit1;
    ...
    sf::Texture left1;
    if (!left1.loadFromFile("files/buttons/images.jpg")){return EXIT_FAILURE;}
    sf::Sprite left;
...
int minutetable()
{
   ...
   sf::Texture table;
   if (!table.loadFromFile("files/table.png")){return EXIT_FAILURE;}
   sf::Sprite table1;
